    ...
    <div class="container">
        ...
        <form action="AdminServlet" method="get">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nameInput" value="${PLACE.name}"/>
            </div>
            <div class="form-group">
                <label for="Address">Address</label>
                <input type="text" class="form-control" name="addressInput" value="${PLACE.address}"/>
            </div>
            <div class="form-group">
                <label for="Descrip">Description</label>
                <input type="text" class="form-control" name="descripInput" value="${PLCAE.descrip}"/>
            </div>
            <br>
